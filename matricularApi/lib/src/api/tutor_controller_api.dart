...
class TutorControllerApi {
  final Dio _dio;

  final Serializers _serializers;

  const TutorControllerApi(this._dio, this._serializers);
  ...
  Future<Response<TutorDTO>> tutorControllerAlterar({
    ...
    final _path = r'/api/v1/tutor/{id}'.replaceAll(
        '{' r'id' '}',
    ...
    try {
      const _type = FullType(TutorDTO);
      _bodyData = _serializers.serialize(tutorDTO, specifiedType: _type);
  ...
  Future<Response<PageTutorDTO>> tutorControllerListAllPage({
    ...
    final _path = r'/api/v1/tutor/page';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<TutorDTO>>> tutorControllerSearchFieldsAction({
    ...
    final _path = r'/api/v1/tutor/search-fields';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PageTutorDTO>> tutorControllerSearchFieldsActionPage({
    ...
    final _path = r'/api/v1/tutor/search-fields/page';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<SearchField>>> tutorControllerSearchFieldsList({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
