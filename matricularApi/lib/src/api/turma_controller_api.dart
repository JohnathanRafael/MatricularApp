...
class TurmaControllerApi {
  ...
  Future<Response<TurmaDTO>> turmaControllerAdicionaAlunos({
    ...
    final _path = r'/api/v1/turma/adiciona-alunos';
  ...
  /// Returns a [Future] containing a [Response] with a [TurmaDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TurmaDTO>> turmaControllerAdicionaUmAluno({
    required int idTurma,
    ...
    final _path = r'/api/v1/turma/adiciona-um-aluno';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      r'idTurma':
          encodeQueryParameter(_serializers, idTurma, const FullType(int)),
      r'idAluno':
          encodeQueryParameter(_serializers, idAluno, const FullType(int)),
    };
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<int>> turmaControllerQuantidadeTotal({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/turma/quantidade-total';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [TurmaDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TurmaDTO>> turmaControllerRemoveAlunosTurma({
    required int idTurma,
    required BuiltList<int> requestBody,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/api/v1/turma/remove-alunos/{idTurma}'.replaceAll(
        '{' r'idTurma' '}',
        encodeQueryParameter(_serializers, idTurma, const FullType(int))
            .toString());
    final _options = Options(
