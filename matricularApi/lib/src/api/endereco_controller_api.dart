...
class EnderecoControllerApi {
  final Dio _dio;

  final Serializers _serializers;

  const EnderecoControllerApi(this._dio, this._serializers);
  ...
  Future<Response<EnderecoDTO>> enderecoControllerAlterar({
    ...
    final _path = r'/api/v1/endereco/{id}'.replaceAll('{' r'id' '}',
    ...
    try {
      const _type = FullType(EnderecoDTO);
      _bodyData = _serializers.serialize(enderecoDTO, specifiedType: _type);
  ...
  Future<Response<PageEnderecoDTO>> enderecoControllerListAllPage({
    ...
    final _path = r'/api/v1/endereco/page';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<EnderecoDTO>>>
    ...
    final _path = r'/api/v1/endereco/search-fields';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PageEnderecoDTO>> enderecoControllerSearchFieldsActionPage({
    ...
    final _path = r'/api/v1/endereco/search-fields/page';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<SearchField>>> enderecoControllerSearchFieldsList({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
