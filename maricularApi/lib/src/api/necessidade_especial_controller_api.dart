...
class NecessidadeEspecialControllerApi {
  final Dio _dio;

  final Serializers _serializers;

  const NecessidadeEspecialControllerApi(this._dio, this._serializers);
  ...
  Future<Response<void>> necessidadeEspecialControllerAlterar({
    ...
    final _path = r'/api/v1/necessidade_esp/{id}'.replaceAll('{' r'id' '}',
    ...
    try {
      const _type = FullType(NecessidadeEspecialDTO);
      _bodyData =
          _serializers.serialize(necessidadeEspecialDTO, specifiedType: _type);
  ...
  Future<Response<void>> necessidadeEspecialControllerIncluir({
    ...
    final _path = r'/api/v1/necessidade_esp';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> necessidadeEspecialControllerListAll({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<void>> necessidadeEspecialControllerListAllPage({
    ...
    final _path = r'/api/v1/necessidade_esp/page';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> necessidadeEspecialControllerSearchFieldsAction({
    ...
    final _path = r'/api/v1/necessidade_esp/search-fields';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> necessidadeEspecialControllerSearchFieldsActionPage({
    ...
    final _path = r'/api/v1/necessidade_esp/search-fields/page';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<SearchField>>>
      necessidadeEspecialControllerSearchFieldsList({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
