...
class PessoaControllerApi {
  final Dio _dio;

  final Serializers _serializers;

  const PessoaControllerApi(this._dio, this._serializers);
  ...
  Future<Response<void>> pessoaControllerAlterar({
    ...
    final _path = r'/api/v1/pessoa/{id}'.replaceAll(
        '{' r'id' '}',
    ...
    try {
      const _type = FullType(PessoaDTO);
      _bodyData = _serializers.serialize(pessoaDTO, specifiedType: _type);
  ...
  Future<Response<void>> pessoaControllerListAllPage({
    ...
    final _path = r'/api/v1/pessoa/page';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> pessoaControllerSearchFieldsAction({
    ...
    final _path = r'/api/v1/pessoa/search-fields';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> pessoaControllerSearchFieldsActionPage({
    ...
    final _path = r'/api/v1/pessoa/search-fields/page';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<SearchField>>> pessoaControllerSearchFieldsList({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
