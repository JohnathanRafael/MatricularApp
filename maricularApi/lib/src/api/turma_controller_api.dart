...
class TurmaControllerApi {
  ...
  Future<Response<void>> turmaControllerAlterar({
    ...
    final _path = r'/api/v1/turma/{id}'.replaceAll('{' r'id' '}',
  ...
  Future<Response<void>> turmaControllerListAllPage({
    ...
    final _path = r'/api/v1/turma/page';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> turmaControllerSearchFieldsAction({
    ...
    final _path = r'/api/v1/turma/search-fields';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> turmaControllerSearchFieldsActionPage({
    ...
    final _path = r'/api/v1/turma/search-fields/page';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<SearchField>>> turmaControllerSearchFieldsList({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
