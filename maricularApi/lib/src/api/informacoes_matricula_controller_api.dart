...
class InformacoesMatriculaControllerApi {
  final Dio _dio;

  final Serializers _serializers;

  const InformacoesMatriculaControllerApi(this._dio, this._serializers);
  ...
  Future<Response<void>> informacoesMatriculaControllerAlterar({
    ...
    final _path = r'/api/v1/infomatricula/{id}'.replaceAll('{' r'id' '}',
    ...
    try {
      const _type = FullType(InformacoesMatriculaDTO);
      _bodyData =
          _serializers.serialize(informacoesMatriculaDTO, specifiedType: _type);
  ...
  Future<Response<void>> informacoesMatriculaControllerIncluir({
    ...
    final _path = r'/api/v1/infomatricula';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> informacoesMatriculaControllerListAllPage({
    ...
    final _path = r'/api/v1/infomatricula/page';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> informacoesMatriculaControllerSearchFieldsAction({
    ...
    final _path = r'/api/v1/infomatricula/search-fields';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> informacoesMatriculaControllerSearchFieldsActionPage({
    ...
    final _path = r'/api/v1/infomatricula/search-fields/page';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
