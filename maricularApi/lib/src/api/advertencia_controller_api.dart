...
class AdvertenciaControllerApi {
  final Dio _dio;

  final Serializers _serializers;

  const AdvertenciaControllerApi(this._dio, this._serializers);
  ...
  Future<Response<void>> advertenciaControllerAlterar({
    ...
    final _path = r'/api/v1/advertencia/{id}'.replaceAll(
        '{' r'id' '}',
  ...
  Future<Response<void>> advertenciaControllerIncluir({
    ...
    final _path = r'/api/v1/advertencia';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> advertenciaControllerListAllPage({
    ...
    final _path = r'/api/v1/advertencia/page';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> advertenciaControllerSearchFieldsAction({
    ...
    final _path = r'/api/v1/advertencia/search-fields';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> advertenciaControllerSearchFieldsActionPage({
    ...
    final _path = r'/api/v1/advertencia/search-fields/page';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
