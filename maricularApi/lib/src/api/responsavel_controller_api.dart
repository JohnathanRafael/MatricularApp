...
class ResponsavelControllerApi {
  final Dio _dio;

  final Serializers _serializers;

  const ResponsavelControllerApi(this._dio, this._serializers);
  ...
  Future<Response<void>> responsavelControllerAlterar({
    ...
    final _path = r'/api/v1/responsavel/{id}'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(PkResponsavel))
            .toString());
    ...
    try {
      const _type = FullType(ResponsavelDTO);
      _bodyData = _serializers.serialize(responsavelDTO, specifiedType: _type);
  ...
  Future<Response<void>> responsavelControllerIncluir({
    ...
    final _path = r'/api/v1/responsavel';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> responsavelControllerListAllPage({
    ...
    final _path = r'/api/v1/responsavel/page';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> responsavelControllerSearchFieldsAction({
    ...
    final _path = r'/api/v1/responsavel/search-fields';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> responsavelControllerSearchFieldsActionPage({
    ...
    final _path = r'/api/v1/responsavel/search-fields/page';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
